...
impl crate::ops::Operation for GetObject {
    ...
    async fn call(&self, ccx: &CallContext<'_>, req: &mut http::Request) -> S3Result<http::Response> {
        ...
        let overridden_headers = crate::ops::get_object::extract_overridden_response_headers(&s3_req)?;
        ...
        crate::ops::get_object::merge_custom_headers(&mut resp, s3_resp.headers);
